...
public:
  ...
  typename simdTypes<T_numtype>::vecType fastRead_tv(sizeType i) const
...
public:
  ...
  typename simdTypes<T_numtype>::vecType fastRead_tv(sizeType i) const
  { return T_op::apply(iter_.fastRead_tv(i)); }
...
public:
  ...
  typename simdTypes<T_numtype>::vecType fastRead_tv(sizeType i) const
    { return T_op::apply(iter1_.fastRead_tv(i), iter2_.fastRead_tv(i)); }
...
public:
  ...
  typename simdTypes<T_numtype>::vecType fastRead_tv(sizeType i) const
    {
        return T_op::apply(iter1_.fastRead_tv(i),
                           iter2_.fastRead_tv(i),
