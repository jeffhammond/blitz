...
public:
  ...
  ptrdiff_t suggestStride(const int rank) const
    { return iter_.suggestStride(rank); }

    bool isStride(const int rank,const ptrdiff_t stride) const
...
public:
  ...
  ptrdiff_t suggestStride(const int rank) const
    {
        ptrdiff_t stride1 = iter1_.suggestStride(rank);
        ptrdiff_t stride2 = iter2_.suggestStride(rank);
...
public:
    ...
    ptrdiff_t suggestStride(const int rank) const {
        ptrdiff_t stride1 = iter1_.suggestStride(rank);
        ptrdiff_t stride2 = iter2_.suggestStride(rank);
        ptrdiff_t stride3 = iter3_.suggestStride(rank);
