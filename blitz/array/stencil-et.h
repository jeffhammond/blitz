...
public:
  ...
  ptrdiff_t suggestStride(const int rank) const { return iter_.suggestStride(rank); }

    bool isStride(const int rank,const ptrdiff_t stride) const { return iter_.isStride(rank,stride); }
